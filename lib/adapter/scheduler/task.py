...
class PeriodicTask(Task):
    ...
    def __init__(
        ...
        super().__init__(func, args, kwargs, task_id, priority, 
                        retry_count, retry_interval, timeout, description)
    ...
    def update_next_run(self):
        ...
        self.next_run = self.last_run.fromtimestamp(self.last_run.timestamp() + self.interval)
