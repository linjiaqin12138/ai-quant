...
LongShortAccountInfo = TypedDict(
    "LongShortAccountInfo",
    {
        "longAccount": float,
        "shortAccount": float,
...
LatestFuturesPriceInfo = TypedDict(
    "LatestFuturesPriceInfo",
    {
        "symbol": str,
        "markPrice": float,
        "indexPrice": float,
...
class BinanceExchange(ExchangeAPI):
    ...
    def __init__(self, test_mode: bool = False, future_mode: bool = False):
        ...
        if future_mode:
            binance_config.update({"options": {"defaultType": "future"}})
    ...
    def _get_long_short_info_factory(
        self,
        api: str,
        symbol: str,
    ...
    def get_u_base_top_long_short_ratio(
        self,
        symbol: str,
        frame: CryptoHistoryFrame,
        start: datetime,
        ...
        return self._get_long_short_info_factory(
            "fapidataGetToplongshortpositionratio", symbol, frame, start, end
        )
    ...
    def get_u_base_top_long_short_account_ratio(
        self,
        symbol: str,
        frame: CryptoHistoryFrame,
        start: datetime,
        ...
        return self._get_long_short_info_factory(
            "fapidataGetToplongshortaccountratio", symbol, frame, start, end
        )

    # https://developers.binance.com/docs/derivatives/usds-margined-futures/market-data/rest-api/Long-Short-Ratio
    def get_u_base_global_long_short_account_ratio(
        self,
        symbol: str,
        frame: CryptoHistoryFrame,
        start: datetime,
        ...
        return self._get_long_short_info_factory(
            "fapidataGetGloballongshortaccountratio", symbol, frame, start, end
        )
    ...
    def create_order(
        ...
        logger.debug(
            f"binance createorder: {type} {side} amount: {amount}, price: {price}"
        )
