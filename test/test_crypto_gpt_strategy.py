...
from lib.strategys.gpt_powerd.gpt_crypto_trade import GptStrategyDependency, GptStrategyParams, OtherDataFetcherAbstract, Context, gpt
...
""")
    ...
    deps = GptStrategyDependency(
        ...
        voter_agents=map_by(['qwen-2-72b', 'wizardlm-2-8x22b', 'llama-3.1-405b'], lambda m: get_agent_by_model(m)),
